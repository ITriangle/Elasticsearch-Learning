...
public class SearchController {
    ...
    public List<String> searchIndexType(@PathVariable String index, @PathVariable String type, @RequestBody String jsonParam) {
    ...
    public List<String> searchIndexType(@PathVariable String index, @RequestBody String jsonParam) {
